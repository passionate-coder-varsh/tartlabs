...
const Home = () => {
  return (
    <section className="bg-center bg-cover absolute top-0 left-0 w-full homebg">
      ...
      <h1 class="text-2xl xs:pt-28 md:pt-0 lg:pt-28
      ...
      <p class="lg:px-96 text-2xl font-light text-center xs:mt-4 text-white xs:pl-24
      ...
      <div class="absolute lg:w-192 md:w-96 sm:w-10 xs:w-10 lg:-mt-8 h-32 homefront left-96  lg:ml-80
                  md:left-16 md:px-80 ">
